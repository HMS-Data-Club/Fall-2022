...
# To prevent code with missing pieces from accidentally running and generating error messages, "eval=FALSE" has been added to the display option of most of the code chunks below. When you are happy with a code chunk, remove "eval=FALSE". 
```
